...
const EditGame = ({ showModal, setShowModal, game }: PropTypes) => {
  ...
  const formSubmit : SubmitHandler<GamesForm> = async (data) => {
    ...
    return showToast({
      message: result.status === "success" ? `Game updated successfully` : String(result.error),
      type: result.status,
    });
  };
            ...
            <div className="relative w-auto my-6 mt-16 mx-auto max-w-5xl sm:w-1/2 md:w-5/12">
              <div className="border-0 rounded-lg shadow-lg relative flex flex-col w-full bg-white outline-none focus:outline-none">
                <div className="flex items-start justify-between p-5 rounded-t ">
                  <h3 className="text-lg font-bold">Update Game</h3>
                  <button
                ...
                <div className="relative p-4 flex-auto">
                  ...
                  >
                    ...
                    <div className="flex items-center justify-end p-6 rounded-b">
                      ...
                      <button className="text-white bg-[var(--button-color)] hover:bg-[var(--blue)] font-bold uppercase text-sm px-6 py-3 rounded shadow hover:shadow-lg outline-none focus:outline-none mr-1">
